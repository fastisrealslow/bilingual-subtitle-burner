...
- 默认后端：SenseVoice Small INT8，sherpa-onnx 1.13.7 CPU，默认 2 线程；实际日常配置读取`asr_production_config.json`。2026-09-06重做素材按精确源哈希显式选择Qwen3-ASR 0.6B与Qwen3-ForcedAligner 0.6B CPU，使用真实完整音频核验任务34035892469；不自动回退或全局替换其他素材。
