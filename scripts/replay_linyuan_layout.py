...
def main():
    ...
    row = dict(id=args.sample, commit=os.environ.get('GITHUB_SHA'),
        run_id=os.environ.get('GITHUB_RUN_ID'), input_run_id='35565180877',
    ...
    try:
        revised = landscape.optional_reframe(meta, output, args.output/'work', requested='landscape')
        ...
        row.update(status='layout_verified', output_final_sha256=revised['fingerprints']['sha256'],
            ...
            video_audio_full_decode=True, title=revised['title'])
